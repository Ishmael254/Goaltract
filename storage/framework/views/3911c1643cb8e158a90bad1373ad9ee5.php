...
<!--                    <p><?php echo Str::limit($data->content, 140); ?></p>-->

<!--                    <a href="<?php echo e(route('viewgroup', $data->slug)); ?>" class="btn btn-success btn-sm">Join Group</a>-->
<!--                </div>-->
<!--            </div>-->
...
<div class="container my-5">
  <center>
    <div class="row g-4">
        ...
        <?php else: ?>
          <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.mylayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home6/bloggerc/goaltract.com/resources/views/search-results.blade.php ENDPATH**/ ?>