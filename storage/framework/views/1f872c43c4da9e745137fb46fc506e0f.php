...
<div class="container mt-5 group-detail-section">
    ...
    <h2 class="group-detail-header"><?php echo e($content->page_name); ?></h2>
    ...
    <div id="toc-content" class="toc-content" style="display: none;">
        <ul>
            ...
            <?php $__currentLoopData = $toc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="toc-item toc-<?php echo e($item['level']); ?>">
                    <a href="#<?php echo e($item['id']); ?>"><?php echo e($item['text']); ?></a>
                </li>
...
<?php echo $__env->make('layouts.mylayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home6/bloggerc/goaltract.com/resources/views/viewgroup.blade.php ENDPATH**/ ?>