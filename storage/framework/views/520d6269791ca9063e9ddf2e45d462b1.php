...
<div class="container py-2">
 ...
 <form action="<?php echo e(route('filter.posts')); ?>" method="POST" class="row g-3">
        ...
        <div class="col-md-4 mt-3">
                <div class="card shadow-sm h-100 border-0" style="border-radius: 15px;">
                    <div class="card-img-top" style="height: 200px;">
                        <img src="<?php echo e($post->image_url ? asset($post->image_url) : 'https://via.placeholder.com/300x200'); ?>" class="img-fluid w-100" style="height: 100%; object-fit: cover; border-top-left-radius: 15px; border-top-right-radius: 15px;" alt="Image">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title" style="color: #2F4F2F; font-weight: bold;"><?php echo e($post->title); ?></h5>
                        <!-- <p class="card-text" style="color: #555;"><?php echo Str::limit($post->content, 100); ?></p> -->
                        <p class="card-text" style="color: #555;"><?php echo e(Str::limit(html_entity_decode(strip_tags($post->content)), 150)); ?></p>
                             <a href="<?php echo e(route('posts.byCategory', $post->category->name)); ?>" style="color: #32CD32; text-decoration: underline;">
                                Category : <?php echo e($post->category->name ?? 'Uncategorized'); ?>

                            </a>
                    </div>
                    <div class="card-footer bg-transparent text-center">
                        <a href="<?php echo e(route('blog.show', $post->slug)); ?>" class="btn btn-success btn-block" style="width: 80%; font-weight: bold; color: white; background-color: #32CD32; border-radius: 25px;">Read More</a>
...
<?php echo $__env->make('layouts.mylayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Prince\Desktop\GoalTract\resources\views/blog/index.blade.php ENDPATH**/ ?>