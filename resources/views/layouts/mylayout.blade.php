...
<head>
    ...
    <title>{{ $seo['title'] ?? 'Goaltract.com' }}</title>
    <meta name="description" content="{{ $seo['description'] ?? 'Default description for the page.' }}">
    <meta name="keywords" content="{{ $seo['keywords'] ?? 'default, keywords' }}">
    <link rel="canonical" href="{{ $seo['canonical'] ?? url()->current() }}">

    <!-- Open Graph Metadata (for social media sharing) -->
    <meta property="og:title" content="{{ $seo['title'] ?? 'Default Page Title' }}">
    <meta property="og:description" content="{{ $seo['description'] ?? 'Default description for the page.' }}">
    <meta property="og:image" content="{{ $seo['og_image'] ?? asset('/images/whatsapp.jpeg') }}">
    <meta property="og:url" content="{{ $seo['canonical'] ?? url()->current() }}">
    <meta property="og:type" content="website">

    <!-- Twitter Card Metadata -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="{{ $seo['title'] ?? 'Default Page Title' }}">
    <meta name="twitter:description" content="{{ $seo['description'] ?? 'Default description for the page.' }}">
    <meta name="twitter:image" content="{{ $seo['twitter_image'] ?? asset('images/default-twitter-image.jpg') }}">
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand" href="{{route('/')}}"">GoalTract</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="{{url('groups')}}">Whatsapp Groups</a>
                 </li>
                 <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="btn btn-primary btn-sm" href="{{url('blogposts')}}">Add Group</a>
                </li class="nav-item">
            </ul>
        </div>
    </div> 
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-2 mb-3">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{route('/')}}" class="text-white">Home</a></li>
            ...
            <div class="col-6 col-md-2 mb-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="{{route('blogposts')}}" class="text-white">Blog</a></li>
